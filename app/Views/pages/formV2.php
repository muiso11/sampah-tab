                ...
                <div class="row no-gutters">
                    ...
                    <div class="col-12">                        
                        <div class="add-button d-flex justify-content-center">
                            <!-- Trigger Modal -->
                            <button type="button" id="dash" class="btn bg-gradient-success mb-3 " data-toggle="modal"
                    ...
                    <div class="col-12">
                                    ...
                                    <tbody>
                                        <?php $i=1; foreach($data_form as $datas) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        <button type="button" class="btn btn-danger mb-3 mr-2" data-toggle="modal" data-target="#delete_<?=$datas['id'];$i;?>" onclick="isDelete(<?=$i?>)">Hapus</button>
                        ...
                        <form action="coba/fix" method="GET">                            
                            <div class="d-flex justify-content-around mt-4">
                                <div class="form-group d-flex">
                                    <label for="tanggal" class="col-form-label" style="margin-right: 20px;">Tanggal: </label>
                                    <input class="form-control" type="date" value="<?= $data_awal['tanggal']?>" id="tanggal" name="tanggal" disabled>
                                </div>
                                <div class="form-group d-flex">
                                    <label for="shift" class="col-form-label" style="margin-right: 20px;">Shift: </label>
                                    <input class="form-control" type="text" id="shift" name="shift" value="<?= $data_awal['shift']?>" disabled>
                                </div>
                                <div class="form-group d-flex">
                                    <label for="nama" class="col-form-label" style="margin-right: 20px;">Nama: </label>
                                    <input class="form-control" type="text" id="nama" name="nama" placeholder="" value="<?= $data_awal['nama']?>" disabled>
                                </div>                                
